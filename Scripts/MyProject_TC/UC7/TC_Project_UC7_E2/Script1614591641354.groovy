...
WebUI.setText(findTestObject('Object Repository/Page_Kunkai Book Shop/input__FirstName (4)'), '')

WebUI.setText(findTestObject('Object Repository/Page_Kunkai Book Shop/input__LastName (4)'), '')

WebUI.setText(findTestObject('Object Repository/Page_Kunkai Book Shop/input__Email (9)'), '')

WebUI.setText(findTestObject('Object Repository/Page_Kunkai Book Shop/input__Subject'), '')

WebUI.setText(findTestObject('Object Repository/Page_Kunkai Book Shop/textarea__Message'), '')
